...
```
````{r}
barplot(-log10(p_values$p_value), names.arg = p_values$column, 
        ylab = 'Parameters', xlab = '-log10(p-value)',
        main = 'Significance of Logistic Regression Parameters',
        col = 'steelblue', border = 'black', xlim = c(0, max(-log10(p_values$p_value)) + 1),
        width = 20)
# Add a significance threshold line (e.g., -log10(0.05))
